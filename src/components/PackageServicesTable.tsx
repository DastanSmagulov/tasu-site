...
function PackingServicesTable() {
  ...
  const updateService = (id: number, field: any, value: number) => {
    setServices(
      services.map((service) =>
  ...
  const updateAdditionalService = (id: number, field: any, value: number) => {
            ...
            <tr key={service.id}>
              ...
              <td className="border p-2">
                <input
                  ...
                  value={service.name}
                  onChange={(e) =>
                    updateService(service.id, "name", Number(e.target.value))
                  }
              ...
              <td className="border p-2">
                <input
                  ...
                  value={service.small}
                  onChange={(e) =>
                    updateService(service.id, "small", Number(e.target.value))
                  }
                  className="w-full p-1 text-center border rounded"
                />
              </td>
              <td className="border p-2">
                <input
                  ...
                  onChange={(e) =>
                    updateService(service.id, "medium", Number(e.target.value))
                  }
                  className="w-full p-1 text-center border rounded"
                />
              </td>
              <td className="border p-2">
                <input
                  ...
                  value={service.large}
                  onChange={(e) =>
                    updateService(service.id, "large", Number(e.target.value))
                  }
                  className="w-full p-1 text-center border rounded"
                />
              </td>
